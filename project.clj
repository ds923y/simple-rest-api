(defproject simple-rest-api "0.0.1-SNAPSHOT"
  ...
  :plugins [[lein-cljfmt "0.6.1"] [lein-zprint "0.3.12"]]
  ...
  :profiles
    {:dev {:aliases
             {"run-dev"
                ["trampoline" "run" "-m" "simple-rest-api.server/run-dev"]},
           :dependencies [[io.pedestal/pedestal.service-tools "0.5.4"]]},
     :uberjar {:aot [simple-rest-api.server]}}
  :main ^{:skip-aot true} simple-rest-api.server)
