(ns simple-rest-api.server
  (:gen-class) ; for -main method in uberjar
  (:require [io.pedestal.http :as server]
            [com.stuartsierra.component :as component]
            [io.pedestal.http.route :as route]
            [simple-rest-api.database :as sys]
...
(defn -main
  ...
  (reset! sys/system (component/start (sys/query-system)))
  (server/start (server/create-server service/service)))
